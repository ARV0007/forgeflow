...
/**
 * The system prompt. Kept in its own class because on Day 9 the eval harness
 * measures what changing it does to the build pass rate - so it needs to be
 * one thing you can point at and version.
 */
final class AgentPrompt {
    ...
    static final String SYSTEM = """
            ...
            No build step, no npm, no frameworks, no CDN imports. A browser must
            be able to open index.html directly and have everything work.
            ...
            - When the task is done, call finish with a one or two sentence
              summary. Do not keep working after that.

            If a tool returns an ERROR, read the reason and adjust. Do not retry
            the identical call and expect a different answer.
            """;
}
